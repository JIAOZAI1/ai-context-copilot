...
const I18N = {
  'zh-CN': {
    ...
    templateSectionDesc: '配置多个模板，选中网页文本后可选其一来调用 AI。{{Text}} 会被替换为选中的文本',
    templateNamePlaceholder: '模板名称',
    templatePromptPlaceholder: '提示词内容，使用 {{Text}} 作为选中文本的占位符',
    templateVarHint: ' 将被替换为用户选中的网页文本',
  ...
  'en': {
    ...
    templateSectionDesc: 'Create multiple templates. When you select text on a webpage, you can choose which template to use. {{Text}} will be replaced with the selected text.',
    templateNamePlaceholder: 'Template name',
    templatePromptPlaceholder: 'Prompt content, use {{Text}} as placeholder for selected text',
    templateVarHint: ' will be replaced with the selected webpage text',
